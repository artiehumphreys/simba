        ...
        <body className={`flex h-screen text-white overflow-hidden ${styles.background_container}`}>
            ...
            <div className="flex-grow w-10/12 p-8 overflow-y-auto mb-20">
                <div className="grid grid-rows-1 gap-4">
                    <div className="bg-gray-800 p-4 rounded-lg cursor-pointer transform transition duration-200 hover:scale-105 w-full md:w-auto">
                        <h3 className="mt-2 text-center text-white">hi</h3>
                    </div>
                </div>
        </div>
